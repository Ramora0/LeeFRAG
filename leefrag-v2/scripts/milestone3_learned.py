"""Milestone 3: learned selector + budget loss (+ optional offline-teacher KL).

Main training entry point. Trains DoRA + norms + the per-layer selector through
the 2x->4x->8x keep-rate anneal.

  python scripts/milestone3_learned.py --epochs 4 --use_kl_teacher \
      --teacher_dir outputs_v2/teacher
"""
...
def main():
    ...
    ap.add_argument("--use_kl_teacher", action="store_true")
